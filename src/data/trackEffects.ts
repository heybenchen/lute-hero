...
export const TRACK_EFFECTS: { [key: string]: TrackEffect } = {
  ...
  harmonize: { type: "harmonize", bonusDamage: 6 },
...
export const TRACK_EFFECT_DESCRIPTIONS: { [key: string]: string } = {
  ...
  harmonize: "Matching dice: +6",
  offbeat: "Odd 3×, Even 0.5×",
  wildDice: "Add one extra d4 roll",
  tempo: "1.5× lowest die as bonus",
  dynamicRange: "Spread ≥6: +6 damage",
  dropTheBass: "Both 1s: +14 damage",
  lucky7: "Any 7 showing: +5 damage",
  powerChord: "3s deal +5 bonus damage",
